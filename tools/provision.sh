...
function platform_linux_main() {
  ...
  brew_postinstall osquery/osquery-local/glibc

  # Build a bottle for a legacy glibc.
  brew_tool osquery/osquery-local/glibc-legacy
  brew_unlink osquery/osquery-local/glibc-legacy
  brew_link osquery/osquery-local/glibc-legacy
  brew_postinstall osquery/osquery-local/glibc-legacy
  ...
  brew_postinstall osquery/osquery-local/gcc
  ...
  brew_postinstall osquery/osquery-local/openssl
  brew_link osquery/osquery-local/openssl
  ...
  brew_postinstall osquery/osquery-local/python
