...
class ZlibArm < AbstractOsqueryFormula
  ...
  def install
    inreplace "configure", "LDFLAGS=\"-L. ${LIBS}\"", "LDFLAGS=\"-L. ${LIBS} ${LDFLAGS}\""

    system "./configure", "--shared", "--prefix=#{prefix}"
    system "make"
    system "make", "install"

    mkdir_p "#{arm_prefix}/lib/pkgconfig"
